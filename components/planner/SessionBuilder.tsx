                                ...
                                {(isAMRAP || isForTime) && (
                                    <div className="flex items-center gap-2 ml-2 border-l border-purple-500/30 pl-4 animate-in fade-in slide-in-from-left-2 w-full sm:w-auto mt-2 sm:mt-0">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <input 
                                                className="w-16 bg-zinc-950 border border-zinc-700 rounded px-2 py-1 text-center text-white focus:border-purple-500 outline-none"
                                                value={block.timeCap || ''}
                                                onChange={(e) => updateBlockMeta(block.id, 'timeCap', e.target.value)}
                                                placeholder="10 min"
                                            />
                                        </div>
                                        {isAMRAP && (
                                            <div className="flex items-center gap-2">
                                                <label className="text-xs text-zinc-500 font-medium whitespace-nowrap">{t('planner.rounds')}</label>
                                                <input 
                                                    className="w-12 bg-zinc-950 border border-zinc-700 rounded px-2 py-1 text-center text-white focus:border-purple-500 outline-none"
                                                    value={block.rounds || ''}
                                                    onChange={(e) => updateBlockMeta(block.id, 'rounds', e.target.value)}
                                                    placeholder="∞"
                                                />
                                ...
                                {isEMOM && (
                                    <div className="flex items-center gap-2 ml-2 border-l border-purple-500/30 pl-4 animate-in fade-in slide-in-from-left-2 w-full sm:w-auto mt-2 sm:mt-0">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <input 
                                                className="w-16 bg-zinc-950 border border-zinc-700 rounded px-2 py-1 text-center text-white focus:border-purple-500 outline-none"
                                                value={block.emomInterval || ''}
                                                onChange={(e) => updateBlockMeta(block.id, 'emomInterval', e.target.value)}
                                                placeholder="1 min"
                                            />
                                        </div>
                                        <div className="flex items-center gap-2">
                                        ...
                                        <label className="flex items-center gap-1.5 text-xs text-zinc-500 cursor-pointer">
                                            <input 
                                                type="checkbox"
                                                checked={block.emomAlternating || false}
